...
namespace SportHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250918155603_AddAuthenticationSecurityFeatures")]
    partial class AddAuthenticationSecurityFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtSport", b =>
                {
                    ...
                    b.HasIndex("CourtsId", "SportsId")
                        .IsUnique();

                    b.ToTable("CourtSport", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Establishment", b =>
                {
                    ...
                    b.Property<string>("TimeZone")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("America/Maceio");
            ...
            modelBuilder.Entity("Domain.Entities.OtpCode", b =>
                {
                    ...
                    b.HasIndex("UserId", "Purpose", "CodeHash");
            ...
            modelBuilder.Entity("Domain.Entities.ResetSession", b =>
                {
                    ...
                    b.ToTable("ResetSessions", (string)null);
                });
            ...
            modelBuilder.Entity("EstablishmentSport", b =>
                {
                    ...
                    b.HasKey("EstablishmentId", "SportId");

                    b.HasIndex("SportId");

                    b.HasIndex("EstablishmentId", "SportId")
                        .IsUnique();
                    ...
                    b.OwnsOne("Domain.ValueObjects.Address", "Address", b1 =>
                        {
                            ...
                            NpgsqlIndexBuilderExtensions.HasMethod(b1.HasIndex("Location"), "GIST");
